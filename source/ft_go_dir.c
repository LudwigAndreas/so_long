...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/04/29 18:11:48 by lsherry           #+#    #+#             */
/*   Updated: 2022/04/29 18:11:49 by lsherry          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_go_west(t_game *game, t_entity *entity)
{
	mlx_put_image_to_window(game->mlx_id, game->window,
		game->sprites.empty, entity->w_pos.x + 3, entity->w_pos.y);
	mlx_put_image_to_window(game->mlx_id, game->window,
		entity->sprite.left->content, entity->w_pos.x, entity->w_pos.y);
...
{
	mlx_put_image_to_window(game->mlx_id, game->window,
		game->sprites.empty, entity->w_pos.x, entity->w_pos.y - 3);
	mlx_put_image_to_window(game->mlx_id, game->window,
		entity->sprite.down->content, entity->w_pos.x, entity->w_pos.y);
...
void	ft_go_east(t_game *game, t_entity *entity)
{
	mlx_put_image_to_window(game->mlx_id, game->window,
		game->sprites.empty, entity->w_pos.x - 3, entity->w_pos.y);
	mlx_put_image_to_window(game->mlx_id, game->window,
		entity->sprite.right->content, entity->w_pos.x, entity->w_pos.y);
...
void	ft_go_north(t_game *game, t_entity *entity)
{
	mlx_put_image_to_window(game->mlx_id, game->window,
		game->sprites.empty, entity->w_pos.x, entity->w_pos.y + 3);
	mlx_put_image_to_window(game->mlx_id, game->window,
		entity->sprite.up->content, entity->w_pos.x, entity->w_pos.y);
